class TcltkAT86 < Formula
  desc "Tcl and Tk Version 8.6"
  ...
  def install
    ...
    Dir.chdir("tk8.6.10/unix"){
      ...
      system "make", "install"
      system "install_name_tool /opt/homebrew/Cellar/tcltk@8.6/8.6.10/bin/wish8.6 -change /opt/homebrew/Cellar/tcltk@8.6/8.6.10/lib:/opt/homebrew/lib/X11/libtk8.6.dylib /opt/homebrew/Cellar/tcltk@8.6/8.6.10/lib/libtk8.6.dylib"
    }
